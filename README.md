# Vibe Color Extension

A simple browser extension that changes the background color of the current webpage to a random color when you click the extension icon or the popup button.
